...
compatibility_constraints = {
    ...
    ct.CPU: {
        ...
        ct.GPU: [
            {"attr1": "is_empty", "op": "not", "apply_for": 1, "lgc_gp": 1, "lgc_op": "or"},
            {"attr1": "integrated_graphics", "op": "bool_vl", "apply_for": 0, "lgc_gp": 1, "lgc_op": "or"},
        ]
    },
    ct.SSD: {
        ct.MOTHERBOARD: [
            # verify if nvme is compatible
            {"attr1": "pcie", "attr2": "pci_slots", "op": "pcie_in_x4_pcies", "lgc_gp": 1, "lgc_op": "or"},
            {"attr1": "pcie", "attr2": "pci_slots", "op": "pcie_in_x8_pcies", "lgc_gp": 1, "lgc_op": "or"},
            {"attr1": "nvme", "op": "bool_vl",  "lgc_gp": 1, "lgc_op": "and"},
            {"attr1": "nvme", "op": "not",  "lgc_gp": 1, "lgc_op": "or"},
            # verify m2 compatibility
            {"attr1": "ssd_format", "op": "is", "arg": "M2", "apply_for": 0, "lgc_gp": 2, "lgc_op": "or"},
            {"attr1": "m2_sockets", "op": "gtz", "apply_for": 1, "lgc_gp": 2, "lgc_op": "and"},
            {"attr1": "ssd_format", "op": "is_not", "arg": "M2", "apply_for": 0, "lgc_gp": 2, "lgc_op": "or"}, 
            # verify sata3 compatibility
            {"attr1": "ssd_format", "op": "is", "arg": "2.5", "apply_for": 0, "lgc_gp": 3, "lgc_op": "or"},
            {"attr1": "sata3_connectors", "op": "gtz", "apply_for": 1, "lgc_gp": 3, "lgc_op": "and"},
            {"attr1": "ssd_format", "op": "is_not", "arg": "2.5", "apply_for": 0, "lgc_gp": 3, "lgc_op": "or"},
            
        ]    
    },
    ct.GPU: {
        ct.MOTHERBOARD: [
            {"attr1": "pcie", "attr2": "pci_slots", "op": "pcie_in_x16_pcies", "lgc_gp": 1, "lgc_op": "or"},
            {"attr1": "is_empty", "op": "bool_vl", "apply_for": 1, "lgc_gp": 1, "lgc_op": "or"},
        ]
    },
    ct.RAM: {},
}
...
class CompatibilityGraphGenerator:
    def __init__(self, components: list[Component], constraints, intra_type_compatibility=False):
    ...
    def _verify_compability(self, comp1, comp2, constraints):
        ...
        if comp1.name == "empty_gpu" or comp2.name == "empty_gpu":
            pass
        ...
        for constr in constraints:
            ...
            if two_vars_op:
                attr2 = getattr(comp2, constr["attr2"]) if "attr2" in constr else constr["arg"]
            ...
            if "lgc_gp" in constr:
                ...
                logicals[lgc_gp] = lgc_op(logicals[lgc_gp], compatible) if lgc_gp in logicals else compatible
    ...
    def generate_graph(self):
        ...
        for comp_type, comps_with_type in self.components.items():
            ...
            for comp in tqdm(comps_with_type):
                for constr_comp_type in ct:
                    ...
                    if constr_comp_type not in self.components or constr_comp_type == comp_type and not self.intra_type_compatibility:
                        continue
        ...
        # nx.draw(G, pos, with_labels=True, labels=labels, node_color=[node_colors[node] for node in G.nodes()], font_weight='bold', font_size=8, node_size=100, alpha=0.9)
        # plt.show()
